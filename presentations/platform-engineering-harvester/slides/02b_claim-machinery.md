...
The same <code>XVirtualMachine</code> KCL module is served by <strong>claim-machinery-api</strong> and consumed two ways — the <code>claims</code> CLI or the Backstage plugin — both rendering one claim into a Git PR. Then it's the <a class="card-link" href="/7">VM flow from before</a>.
</p>
